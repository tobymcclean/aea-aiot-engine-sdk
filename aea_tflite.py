...
from object_detector import InferenceEngine
...
def build_inference_engine(model_file: str, labels_file: str):
...
def main():
    ...
    engine = InferenceEngine(properties_str=properties_str,
                             inference=build_inference_engine(args['model'], args['label']))
    engine.run()
    return 0
